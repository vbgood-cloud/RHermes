...
学习模式:
  ...
  Home/End     — 光标到行首/行尾";
                    ...
                    // 教育模式斜杠命令
                    cmd if cmd.starts_with("/course") || cmd.starts_with("/class") || cmd.starts_with("/lesson") || cmd.starts_with("/student") || cmd.starts_with("/roster") || cmd.starts_with("/courses") || cmd.starts_with("/profile") || cmd.starts_with("/report") || cmd.starts_with("/mode ") || cmd.starts_with("/auth login") || cmd.starts_with("/assignment") || cmd.starts_with("/assignments") || cmd.starts_with("/submit") || cmd.starts_with("/feedback") || cmd.starts_with("/import") || cmd.starts_with("/set ") || cmd == "/setup" => {
