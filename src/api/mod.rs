...
pub fn default_tools() -> Vec<ToolDef> {
    vec![
        ...
        ToolDef {
            ...
            function: ToolFunction {
                name: "read_docx".into(),
                description: "读取 Word .docx 文件，返回纯文本内容".into(),
                parameters: serde_json::json!({"type": "object","properties": {"path": {"type": "string", "description": ".docx 文件路径"}},"required": ["path"]}),
            },
        },
        ToolDef {
            tool_type: "function".into(),
            function: ToolFunction {
                name: "read_pptx".into(),
                description: "读取 PowerPoint .pptx 文件，按幻灯片返回文本".into(),
                parameters: serde_json::json!({"type": "object","properties": {"path": {"type": "string", "description": ".pptx 文件路径"}},"required": ["path"]}),
            },
        },
        ToolDef {
            tool_type: "function".into(),
            function: ToolFunction {
                name: "read_xlsx".into(),
                description: "读取 Excel .xlsx 文件，返回表格数据".into(),
                parameters: serde_json::json!({"type": "object","properties": {"path": {"type": "string", "description": ".xlsx 文件路径"},"sheet": {"type": "string", "description": "工作表名称（默认第一个）"}},"required": ["path"]}),
            },
        },
        ToolDef {
            tool_type: "function".into(),
        ...
        ToolDef {
            ...
            function: ToolFunction {
                ...
                description: "创建 Word .docx 文件，支持标题/段落/表格".into(),
                parameters: serde_json::json!({"type": "object","properties": {"path": {"type": "string", "description": "输出 .docx 文件路径"},"sections": {"type": "string", "description": "JSON 数组：[{heading,content,level}]"}},"required": ["path","sections"]}),
            },
        },
        ToolDef {
            tool_type: "function".into(),
            function: ToolFunction {
                ...
                description: "创建 PowerPoint .pptx 文件，支持标题和列表".into(),
                parameters: serde_json::json!({"type": "object","properties": {"path": {"type": "string", "description": "输出 .pptx 文件路径"},"slides": {"type": "string", "description": "JSON 数组：[{title,bullets,note}]"}},"required": ["path","slides"]}),
            },
        },
        ToolDef {
            tool_type: "function".into(),
            function: ToolFunction {
                name: "write_xlsx".into(),
                description: "创建 Excel .xlsx 文件，支持多 sheet 和数据写入".into(),
                parameters: serde_json::json!({"type": "object","properties": {"path": {"type": "string", "description": "输出 .xlsx 文件路径"},"sheets": {"type": "string", "description": "JSON 数组：[{name,rows[[cell]]}]"}},"required": ["path","sheets"]}),
            },
        },
        ToolDef {
            tool_type: "function".into(),
            function: ToolFunction {
                name: "fill_docx_template".into(),
                description: "填充 Word 模板中的 {{占位符}}，输出新文档".into(),
                parameters: serde_json::json!({"type": "object","properties": {"template": {"type": "string", "description": "模板 .docx 文件路径"},"output": {"type": "string", "description": "输出 .docx 文件路径"},"vars": {"type": "string", "description": "JSON 对象：{\"key\": \"value\"}"}},"required": ["template","output","vars"]}),
            },
        },
    ]
}
